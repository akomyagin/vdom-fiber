...
Проверенный портфельный пайплайн (с Fable 5):
...
4. **Sonnet 5** (основной чат) — проверка тестового покрытия, написание/прогон тестов,
   проверка работоспособности.
5. **Opus** (Agent-тул, `model: opus`) — независимое ревью `/code-review` на diff ветки.
6. Цикл исправлений — до **3 итераций** между ревью и правками.
7. **Commit + push + PR** (conventional-commit, русский subject) в `master`; после
